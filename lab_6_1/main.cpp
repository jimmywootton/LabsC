...
int main()
{
    ...
    ex1.buildTree();
    cout<<"expression 1: "<<expr1<<endl; //prints original expression
    cout<<"infix: "; ex1.infix(); cout<<endl; //prints infix order
    cout<<"prefix: "; ex1.prefix(); cout<<endl; //prints pre order
    cout<<"postfix: "; ex1.postfix(); cout<<endl; //prints post order
